...
export default function AuditLog() {
  const [waktuFilter, setWaktuFilter] = useState('Hari Ini');
  ...
  const logs = [
    ...
    { id: 4, waktu: '08:30:00', admin: 'Sistem', divisi: 'Fasilitas', aksi: 'Auto Rekonsiliasi', detail: 'Midtrans payment gateway', ip: '127.0.0.1', color: 'bg-[#F2F2F2] text-[#555555]' },
  ...
  const filteredLogs = logs.filter(log => {
    const matchesDivisi = divisiFilter === 'Semua' || log.divisi === divisiFilter;
    const matchesSearch =
      ...
      <div className="card-section p-6">
        <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between">
          <div className="flex flex-wrap items-center gap-4">
            ...
            {/* Filter Divisi — menggantikan filter Operator */}
            <div className="flex items-center gap-2">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-50">
              {filteredLogs.length > 0 ? (
                ...
                <tr>
                  <td colSpan={6} className="p-8 text-center text-xs text-[#8A857F] font-bold">
