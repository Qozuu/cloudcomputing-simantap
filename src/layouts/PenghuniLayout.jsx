            ...
            <div className="p-4 border-t border-gray-100 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col min-w-0">
                  <span className="text-sm font-bold text-[#1E1E1E] truncate">Hendra Gunawan</span>
                  <span className="text-xs text-gray-400 truncate">Penghuni — Unit 12A</span>
                </div>
              </div>
              <button
      ...
      <div className="hidden md:flex md:shrink-0">
        <aside className="sidebar h-full flex flex-col bg-white">
          ...
          <div className="sidebar-branding flex items-center justify-between md:justify-start gap-1 pl-1 pr-4 md:pr-0 select-none">
            ...
            {/* Tombol Tutup X (Hanya muncul saat drawer terbuka di layar HP) */}
            <button 
              onClick={() => setIsMobileOpen(false)} 
